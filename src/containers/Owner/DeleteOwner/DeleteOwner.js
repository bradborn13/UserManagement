   ...
   <Col md={10}>
       <Well>
           ...
           <Row>
              ...
              <Col md={7}>
                  <span name='dateOfBirth'><Moment format="MM/DD/YYYY">{owner.dateOfBirth? owner.dateOfBirth :"empty"}</Moment></span>
              </Col>
           </Row>
           <Row>
              <Col md={3}>
              ...
              <Col md={7}>
                  <span name='address'>{owner.address?owner.address:'empty'}</span>
              </Col>
            </Row>
       </Well>
    </Col>
